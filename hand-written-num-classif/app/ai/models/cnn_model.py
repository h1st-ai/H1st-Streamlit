...
def build_tensorflow_cnn_classifier(input_shape=(None, None, 3), n_class=3, classifier_activation='softmax'):
...
class CNNNumberClassifier(h1.MLModel):
    def __init__(self):
        self.base_model = build_tensorflow_cnn_classifier(input_shape=(28, 28, 1), n_class=10)
